                ...
                <form class="home-contact__form" method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
                    ...
                    <div class="home-contact__form-group-1">
                        <label class="home-contact__form-group" title="姓名">
                            <span>姓名:</span>
                            <input type="text" name="name" placeholder="请输入姓名"  class="home-contact__input" required>
                        </label>
                        <label class="home-contact__form-group" title="电话">
                            <span>电话:</span>
                            <input type="text" name="phone" placeholder="请输入电话号码"  class="home-contact__input">
                        </label>
                        <label class="home-contact__form-group" title="邮箱">
                            <span>邮箱:</span>
                            <input type="email" name="email" placeholder="请输入邮箱" class="home-contact__input">
                        </label>
                        <label class="home-contact__form-group" title="企业">
                            <span>企业:</span>
                            <input type="text" name="company" placeholder="请输入企业名称" class="home-contact__input">
                        </label>
                        <label class="home-contact__form-group" title="城市">
                            <span>城市:</span>
                            <input type="text" name="city" placeholder="请输入所在城市" class="home-contact__input">
                        </label>
                    </div>

                    <div class="home-contact__form-group-2">
                        <label class="home-contact__form-group-content" title="内容">
                            <span>内容:</span>
                            <textarea name="message" placeholder="请输入咨询内容" class="home-contact__input-2"></textarea>
                        </label>
                    </div>  
